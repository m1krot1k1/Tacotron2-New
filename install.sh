    ...
    while true; do
        ...
        case $main_choice in
            ...
            3)
                ...
                echo "----------------------------------------"
                echo "1. 🔍 Оптимизация гиперпараметров (рекомендуется для первого запуска)"
                echo "2. 🚀 Обучение с лучшими параметрами (после оптимизации)"
                echo "3. 📊 Мониторинг существующего обучения"
                echo "----------------------------------------"
                read -p "Выберите режим [1-3]: " training_mode
                
                case $training_mode in
                    1)
                        echo ""
                        echo "🔍 РЕЖИМ: Оптимизация гиперпараметров"
                    ...
                    3)
                        ...
                        ;;
                    *)
                        echo "❌ Неверный выбор. Запускаем режим обучения по умолчанию..."
                        run_command "python smart_tuner_main.py --mode train"
                        ;;
                esac
