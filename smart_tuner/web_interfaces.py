...
class WebInterfaceManager:
    ...
    def print_dashboard(self):
        ...
        print(f"  🌐 Streamlit                 http://127.0.1.1:5003")
        print("🔧 Компоненты Smart Tuner:")
        print(f"  🌐 Log Watcher               http://127.0.1.1:5004")
        print(f"  🌐 Metrics Store             http://127.0.1.1:5005")
        print(f"  🌐 Optimization Engine       http://127.0.1.1:5006")
        print(f"  🌐 Param Scheduler           http://127.0.1.1:5007")
        print(f"  🌐 Early Stop Controller     http://127.0.1.1:5008")
        print(f"  🌐 Alert Manager             http://127.0.1.1:5009")
        print(f"  🌐 Model Registry            http://127.0.1.1:5010")
        print("=" * 60)
