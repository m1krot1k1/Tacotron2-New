...
search_space:
  # Оптимизатор
  learning_rate: {type: "loguniform", low: 1e-5, high: 1e-2, default: 1e-3}
  weight_decay: {type: "loguniform", low: 1e-8, high: 1e-3, default: 1e-6}
  # Архитектура
  encoder_embedding_dim: {type: "choice", choices: [256, 512], default: 512}
  decoder_rnn_dim: {type: "choice", choices: [768, 1024], default: 1024}
  dropout_decoder: {type: "uniform", low: 0.0, high: 0.5, default: 0.1}
  # Обучение
  batch_size: {type: "choice", choices: [24, 32, 48], default: 32}
  grad_clip_thresh: {type: "uniform", low: 0.5, high: 1.5, default: 1.0}
  # Параметры аудио
  mel_fmax: {type: "choice", choices: [7600, 8000, null], default: 8000}
...
resources:
  ...
  checkpointing:
    path: "output/autotuner_run" # Путь для сохранения чекпоинтов
